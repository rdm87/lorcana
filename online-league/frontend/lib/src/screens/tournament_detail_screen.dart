...
class _TournamentDetailScreenState extends State<TournamentDetailScreen> {
  ...
  void _reload({bool silent = false}) {
    if (!mounted) return;
    setState(() => _future = widget.api.tournament(widget.tournamentId));
    if (!silent) {
                      ...
                      LayoutBuilder(builder: (context, c) {
                        if (c.maxWidth > 850) {
                          return Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                            ...
                            Expanded(flex: 2, child: _PlayersPanel(registrations: t.registrations)),
                          ]);
                        }
                        return Column(children: [
                          _RegisterPanel(t: t, api: widget.api, onChanged: () => _reload(silent: true)),
                          const SizedBox(height: 18),
                          _PlayersPanel(registrations: t.registrations),
                        ]);
                      }),
                    ]),
                  ),
            ...
            Wrap(
              ...
              children: t.prizeDistribution.map((p) {
                ...
                return Container(
                  ...
                  child: Text(
                    '$medal  ${p.percentage.toStringAsFixed(0)}%',
    ...
    final ok = await showDialog<bool>(
      ...
      builder: (_) => AlertDialog(
        ...
        actions: [
          ...
          FilledButton(onPressed: () => Navigator.pop(context, true), child: const Text('Sì, cancella')),
        ],
      ),
    );
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          if (!session.isLogged) ...[
            Text(
              'Effettua il login con Discord per iscriverti.',
            ...
            // User is registered — show details + status
            Container(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Row(children: [
                  ...
                  Expanded(
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      Text(
                        '${myReg.firstName} ${myReg.lastName}',
                        style: const TextStyle(fontWeight: FontWeight.w700, fontSize: 15),
                      ),
                      Text(
                        'Discord: ${myReg.discordAccount}',
            ...
            Container(
              ...
              child: Row(children: [
                ...
                const SizedBox(width: 10),
                Expanded(child: Text(
                  'Il torneo ha raggiunto il numero massimo di iscritti.',
            ...
            Text(
              'Compila i dati per iscriverti. L\'account Discord viene precompilato.',
              style: Theme.of(context).textTheme.bodyMedium?.copyWith(color: Colors.grey.shade700),
            ),
            const SizedBox(height: 16),
            Form(
...
class _PlayersPanel extends StatelessWidget {
  ...
  const _PlayersPanel({required this.registrations});
                  ...
                  Container(
                    ...
                    child: Text(
                      ...
                      style: TextStyle(
                        fontSize: 12,
                        fontWeight: FontWeight.w800,
                        color: i < 3 ? const Color(0xFF2D145C) : const Color(0xFF5D2EA6),
                      ),
                    ),
                  ),
                  const SizedBox(width: 10),
